...
//    Route::namespace('Aluno')->group(function(){
//        Route::get('aluno', 'Aluno\AlunoController@index')->name('alunos.dados');
...
//    });
    ...
    Route::namespace('Gestor')->group(function(){
        ...
        //Rotas para Alunos
        Route::get('alunos', 'AlunoController@indexAlunos')->name('gestores.alunos');
