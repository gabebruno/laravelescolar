...
@section('frame1')
    ...
    <form action="{{ route('materia.update', $dado['id']) }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="input-group col-sm-4 mb-3 offset-2">
                        <input type="text" name="user_id" class="form-control" placeholder="Professor" value="{{ $dado['user_id'] }}" required>
                    </div>
                </div>
